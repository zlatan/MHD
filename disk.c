...
int main(void)
{
	...
	double DQx=2*Qx0/(2*Nx), DQy=2*Qy0/(2*Ny), DQz=2*Qz0/(2*Nz), rnx, rny, rnz, vn, bn;
  double Q=0.0;
				...
				{int kx=ix-jx+Nx; if(kx<0) continue; if(kx>Lx) continue;
					...
					{int ky=iy-jy+Ny; if(ky<0) continue; if(ky>Ly) continue;
					    ...
					    bbxx[ix][iy][iz]+=bx[jx][jy][jz]*bx[kx][ky][kz]; bbxy[ix][iy][iz]+=bx[jx][jy][jz]*by[kx][ky][kz]; bbxz[ix][iy][iz]+=bx[jx][jy][jz]*bz[kx][ky][kz];
						 ...
						 //bv
							bvxx[ix][iy][iz]+=bx[jx][jy][jz]*vx[kx][ky][kz]; bvxy[ix][iy][iz]+=bx[jx][jy][jz]*vy[kx][ky][kz]; bvxz[ix][iy][iz]+=bx[jx][jy][jz]*vz[kx][ky][kz]; // <<<<<<<<<<< DA SE PROVERI FORMULATA bvxz[ix][iy][iz]+=bx[jx][jy][jz]*vv[kx][ky][kz];
	...
	{int Qx=-Qx0+ix*DQx;
		...
		{int Qy=-Qy0+iy*DQy;
			...
			{int Qz=-Qz0+iz*DQz;
			 ...
			 // magnetic projection
			 rnbx[ix][iy][iz]-=rnx*bn; rnby[ix][iy][iz]-=rny*bn; rnbz[ix][iy][iz]-=rnz*bn; // <<<<<<<<<<< DA SE PROVERI FORMULATA
			}
		}
	}
